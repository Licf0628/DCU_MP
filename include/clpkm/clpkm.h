...
#include <iostream>
#include <vector>
#define CLPKM_DEBUG_PRINT	0		//无证书运算开启打印调试
...
public:
	...
	int setMKeyPair(Big& mprikey, Epoint& mpubkey);
	SM2_KEY getMKeyPair(void);
    /*无证书生成签名和验签相关方法*/
...
void hexArray2bytes(const uint8_t* hexStr, uint8_t* byteArray, size_t byteArraySize);
